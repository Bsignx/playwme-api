      ...
      <Container className="container-fluid">
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block>
              <h2 id="mainHeader">Welcome to Playwme Games!</h2>
              <P>
                Here you can add different games, categories and publishers to
                our amazing game store 😝
              </P>
